    ...
    return (
        <div className="mx-auto w-full max-w-7xl">
            <aside className="relative overflow-hidden text-black rounded-lg sm:mx-16 mx-2 py-10 sm:py-16">
                ...
                <div className="absolute left-0 top-0 flex items-center w-full h-full pointer-events-none">
                    <img
                        className="relative z-0 w-48 sm:w-72 md:w-80 lg:w-96"
            ...
            <div className="grid place-items-center mt-10 sm:mt-20">
                <img
                    className="w-48 sm:w-72 md:w-80 lg:w-96"
